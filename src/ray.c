...
/**
 * Finds horizontal intersection with the wall
 * @param rayAngle: current ray angle
 */
...
/**
 * Finds vertical intersection with the wall
 * @param rayAngle: current ray angle
 */
...
/**
 * Casts a single ray and determines its intersection with walls.
 * @param rayAngle: current ray angle
 * @param stripId: ray strip identifier
 */
...
/**
 * Casts all rays for the current frame.
 */
...
/**
 * Draws all the rays on the screen.
 */
